...
INTERNAL_IPS = decouple.config('INTERNAL_IPS', cast=decouple.Csv(), default='127.0.0.1')
...
DATABASES = {
    'default': decouple.config('DATABASE_URL', default=default_db_url, cast=parse_datebase)
...
#STORANGE CONFIGURATION IN S3 AWS
